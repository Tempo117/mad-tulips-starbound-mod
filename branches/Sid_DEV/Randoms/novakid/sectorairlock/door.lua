...
function hasCapability(capability)
  ...
  if capability == 'door' then
    return true
  elseif (capability == 'closeWall') and ((self.anchor == "top")or(self.anchor == "bottom")) then
	return isDoorClosed()
  elseif (capability == 'closeFloor') and ((self.anchor == "left")or(self.anchor == "left")) then
    return isDoorClosed()
  elseif (capability == 'closedDoor') and ((self.anchor == "top")or(self.anchor == "bottom")) then
    return isDoorClosed()
  else
    return false
  end
